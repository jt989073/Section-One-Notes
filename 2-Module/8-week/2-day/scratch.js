...
const height = sizeInInches => `You are ${sizeInInches} inches tall`

const james = height.bind("this value literally doesn't matter at all because arguments/paramenters in JS are ordered", 72)
